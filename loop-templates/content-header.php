...
<header class="entry-header pt-5 pb-0 pb-lg-5">
    ...
    <div class="col-lg-9">
        ...
        <?php if(get_field('pdf_file') || get_field('pdf_link')): ?>
            ...
            ?>
            <a class="btn btn-secondary px-3 py-2" href="<?php echo esc_url($pdf); ?>" target="_blank" rel="noopener,noreferrer"><?php if(lang_en()) { echo 'View PDF Version'; } elseif(lang_fr()) { echo 'Ouvrir la version PDF'; } ?> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-external-link.svg" alt="External Link"></a>
        <?php endif; ?>
