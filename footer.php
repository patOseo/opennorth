		...
		<footer class="site-footer text-white py-3" id="colophon">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-6">
					...
					<div class="mb-5 w-75">
						<h3 class="h4 mb-4">About Us</h3>
						<p>We foster effective, responsible, and collaborative use of data and technology and solve complex problems.</p>
					</div>
					<div class="footer-social">
						<a href="https://www.linkedin.com/company/open-north/" target="_blank" rel="noopener,noreferrer">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-linkedin.svg" alt="Open North on LinkedIn" width="36" height="36">
						</a>
						<a class="ms-4" href="https://twitter.com/opennorth" target="_blank" rel="noopener,noreferrer">
