                    ...
                    <?php while(have_rows('networks', 'option')): the_row(); ?>
                        ...
                        <li class="col col-sm-6 col-lg-4">
                            <div class="uk-panel position-relative network d-flex flex-column bg-white rounded-3 px-4 pb-4 h-100 mx-3 border-offset text-center">
                                ...
                                <div class="network-title <?php if(strlen(get_sub_field('network_title')) > 60) { echo 'fs-5'; } else { echo 'fs-4'; } ?> lh-sm mb-3"><?php echo get_sub_field('network_title'); ?></div>
                                <div class="network-subheading fs-6 lh-sm mb-4"><?php echo get_sub_field('network_subheading'); ?></div>
                                <div class="network-buttons mt-auto">
                                    <?php if(get_sub_field('case_study_link')): ?>
                                        <a href="<?php echo get_sub_field('case_study_link'); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-primary mb-3"><?php if(lang_en()) { echo 'Learn more'; } elseif(lang_fr()) { echo 'En savoir plus'; } ?> 
